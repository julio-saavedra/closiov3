...
const FeatureCard: React.FC<FeatureCardProps> = ({ feature, index, gridArea }) => {
  ...
  const layoutTemplates = {
    0: {
      artPosition: 'absolute -left-16 top-1/2 -translate-y-1/2 w-[280px] h-[280px]',
      artOpacity: 'opacity-[0.35]',
      contentPosition: 'absolute right-0 top-1/2 -translate-y-1/2 pr-10',
      contentMaxWidth: 'max-w-[45%]',
      contentAlign: 'items-end text-right',
      artGradient: 'after:absolute after:inset-0 after:bg-gradient-to-r after:from-transparent after:via-transparent after:to-black/30',
    },
    1: {
      artPosition: 'absolute -right-12 top-1/2 -translate-y-1/2 w-[240px] h-[240px]',
      artOpacity: 'opacity-[0.40]',
      contentPosition: 'absolute left-0 top-1/2 -translate-y-1/2 pl-10',
      contentMaxWidth: 'max-w-[50%]',
      contentAlign: 'items-start text-left',
      artGradient: 'after:absolute after:inset-0 after:bg-gradient-to-l after:from-transparent after:via-transparent after:to-black/30',
    },
    2: {
      artPosition: 'absolute -bottom-16 left-1/2 -translate-x-1/2 w-[320px] h-[220px]',
      artOpacity: 'opacity-[0.40]',
      contentPosition: 'absolute top-0 left-0 pt-10 pl-10',
      contentMaxWidth: 'max-w-[55%]',
      contentAlign: 'items-start text-left',
      artGradient: 'after:absolute after:inset-0 after:bg-gradient-to-b after:from-transparent after:via-transparent after:to-black/25',
    },
    3: {
      artPosition: 'absolute -top-16 left-1/2 -translate-x-1/2 w-[280px] h-[200px]',
      artOpacity: 'opacity-[0.45]',
      contentPosition: 'absolute bottom-0 left-0 pb-10 pl-10',
      contentMaxWidth: 'max-w-[60%]',
      contentAlign: 'items-start text-left',
      artGradient: 'after:absolute after:inset-0 after:bg-gradient-to-t after:from-transparent after:via-transparent after:to-white/20',
    },
    4: {
      artPosition: 'absolute -bottom-12 -right-12 w-[260px] h-[260px]',
      artOpacity: 'opacity-[0.40]',
      contentPosition: 'absolute top-0 left-0 pt-10 pl-10',
      contentMaxWidth: 'max-w-[52%]',
      contentAlign: 'items-start text-left',
      artGradient: 'after:absolute after:inset-0 after:bg-gradient-to-br after:from-transparent after:via-transparent after:to-black/25',
    },
  };
